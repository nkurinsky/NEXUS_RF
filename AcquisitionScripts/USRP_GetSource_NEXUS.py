...
res     = 4.241265      ## Al   [GHz] - FNAL-I, NR-30
...
## Set the duration of the data acqusistion
run_time = 60 * 60 ## passed in seconds, default to one hour
sub_time =  5 * 60 ## passed in seconds, default to five minutes
...
def doRun(this_power):
    ...
    cal_freqs, cal_means = runNoise(
        ...
        lapse_noise = args.timeSub,   ## Passed in seconds
        points  = args.points,
        ntones  = N_power,
